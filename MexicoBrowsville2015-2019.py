...
#------------------------------------------------------------------------------------------------------------
#Se seleccionan los datos que sean del año 2015 al 2019, tengan frontera US-Mexico Border y Port Name sea Brownsville
 
#mes x 

#Se seleccionan los datos que correspondan con Border = US-Mexico Border
border1 = fronteras["Border"] == "US-Mexico Border"
#Se seleccionan los datos que correspondan con los años 2015, 2016, 2017, 2018
fecha1 = fronteras["Date"].dt.strftime("%Y").isin(["2015","2016","2017","2018"])
...
mes1 = fronteras["Date"].dt.strftime("%m") == "12"
