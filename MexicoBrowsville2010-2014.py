...
#------------------------------------------------------------------------------------------------------------
#Se seleccionan los datos que sean del año 2010 al 2014,  tengan frontera US-Mexico Border y Port Name sea Brownsville

#mes x

#Se seleccionan los datos que correspondan con Border = US-Mexico Border
border1 = fronteras["Border"] == "US-Mexico Border"
#Se seleccionan los datos que correspondan con los años 2010, 2011, 2012, 2013, 2014
fecha1 = fronteras["Date"].dt.strftime("%Y").isin(["2010","2011","2012","2013","2014"])
